...
namespace Domian
{
    ...
    public class Product
    {
        ...
        public Product(string name, decimal price, Category category, Brand brand, Stock stock, string? description = null, int? discountPercentage = null)
        {
            Name = name;
        ...
        public Product() : this(null!, 0, null!, null!, null!) { }
